...
urlpatterns = [
    ...
    # path('games/<int:game_id>/bachelor/', views.add_bachelor, name='add_bachelor'),
    path('bachelor/<int:pk>/update/', views.BachelorUpdate.as_view(), name='bachelor_update'),
    path('games/<int:game_id>/bachelor/<int:bachelor_id>/delete', views.remove_bachelor, name='bachelor_delete'),
    path('games/<int:game_id>/all_bachelorettes', views.all_bachelorettes, name='bachelorettes'),
    path('games/<int:game_id>/create_bachelorette', views.BacheloretteCreate.as_view(), name='bachelorette_create'),
